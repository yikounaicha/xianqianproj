...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        <script language="javascript">
           ...
           function renwuShouhuo(id)
           {
               if(confirm('您确定收货吗？'))
               {
                   window.location.href="<%=path %>/renwu?type=renwuShouhuo&id="+id;
               }
           }
	...
	<body leftmargin="2" topmargin="2" background='<%=path %>/img/allbg.gif'>
			<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
				...
				<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
					...
					<td bgcolor="#FFFFFF" align="center">
					    ${renwu.zt}&nbsp;&nbsp;
					    <c:if test="${renwu.zt=='已接单'}">
					        <a href="#" onclick="renwuShouhuo(${renwu.id})" style="color: red">确认收货</a>
					    </c:if>	
					</td>
					<td bgcolor="#FFFFFF" align="center">
			...
			<table width='98%'  border='0'style="margin-top:8px;margin-left: 11px;">
			  <tr>
			    <td>
			      <input type="button" value="发布任务" style="width: 123px;" onclick="renwuAdd()" />
			    </td>
			  </tr>
		    </table>
