...
-- ----------------------------
INSERT INTO `t_gonggao` VALUES ('1556208234444', '在网上做任务就能赚钱是真的吗？ ', '<p>在网上做任务就能赚钱是真的吗？当然是真的，现实中，只要你完成相应的任务，比如：参与线下实验任务、代取快递，只要你做得好，就能获得一定的报酬。<br />\r\n<br />\r\n网络上做任务和现实中有一些相通性，但是通过网络则显得更简单些，也许你只要一部智能手机就可以。目前比较火的手机威客APP，就是可以通过在上面做任务赚取酬金，发任务赚取活动差价的，在这里，我介绍两款非常靠谱的任务软件：</p>', '2019-04-26 00:02');
INSERT INTO `t_gonggao` VALUES ('1556208259829', '挣闲钱校园平台', '本网讯 通过网络赚钱有许多方式，校园任务平台就是其中的一种。人们所拥有的无穷的创意智慧是有价值的，许多大学生通过努力，在挣闲钱平台上利用课余时间赚到了钱。一起看看他们是怎么做到的。', '2019-04-26 00:03');
...
-- Records of t_renwu
-- ----------------------------
INSERT INTO `t_renwu` VALUES ('1556209603184', '1495900651209', '中介管理软件开发', '<p>需要开发一款中介管理软件，网页版，以及app端</p>', '', '2', '2019-05-04 00:26', '1', '待接单', '0');
...
-- Records of t_xinwen
-- ----------------------------
INSERT INTO `t_xinwen` VALUES ('1556208302736', '设计师有哪些渠道赚钱', '<p>设计师可以通过线上和线下接单。线下可以自己开店，开一家做设计的店面，去接一些个人、个体户及小企业的单。个体及小企业为了节约成本，会找到设计师接单，能比设计公司成本低很多。如果手里有资源或者过去工作有比较信任自己的客户，可以承接一些设计项目。</p>', '/upload/1556208301573.jpg', '2019-04-26 00:05');
INSERT INTO `t_xinwen` VALUES ('1556208428883', '随时随地发布任意任务，随时随地接取任务', '<p>初页：解决了哪些问题？主要用户是谁？市场情况及发展趋势如何？我们的主要用户的来源可以分布到全民。<br />\r\n<br />\r\n第一阶段：从学生阶段起步，让学生告别黑中介（信用模式及任务的发布需支付薪资后给予显示）、告别虚假信息（可见信息都是已支付薪资的任务，APP自带双过滤信息系统）<br />\r\n第二阶段：从上班族及年轻一族发展，让人们平时找朋友帮忙却又欠下人情债的习惯彻底远去。（任何事情任何难题都可以发布让全城帮你想办法）让年轻人有更多时间去&ldquo;偷闲&rdquo;（应用到生活，把身边的事情发布为任务尽情享受一朝闲暇）增加收入（在上班之余、下班之后刷新任务让零钱逐渐充实）<br />\r\n第三阶段：兼职市场的用户有很多，但是我们想要的不仅是兼职，让身边触手可及的事情全部被互联网应用。</p>', '/upload/1556208427523.png', '2019-04-26 00:07');
INSERT INTO `t_xinwen` VALUES ('1556208489386', '五月最美奋斗季', '<p>五月是劳动的节日。&ldquo;幸福都是奋斗出来的&rdquo;。走进新时代，引领新时代，都是&ldquo;奋斗者&rdquo;&ldquo;撸起袖子加油干&rdquo;的火热景象。每当黄金5月，也是无数创业者创造财富、实现自身价值的好时机。</p>', '/upload/1556208487897.jpg', '2019-04-26 00:08');
INSERT INTO `t_xinwen` VALUES ('1556208531421', 'IT类相关网站推荐', '<p>网络技术，无论是php还是java ，无论是pc时代，还是移动时代，无论是黑客技术，还是程序新人，it技术，无疑是当前最火的行业，无论是个人爱好还是工程技术开发，都吸引了无数的人才。各种与网络技术，教程学习，工程开发相关的网站也如同雨后春笋般出现在网民的面前。<br />\r\n<br />\r\n在这里，向广大校友推荐以下十个技术人员经常上的网站，各网站的排名根据目前各大通信门户、论坛、blog网友的推荐和投票产生。同时，在这里向这些论坛的管理人员表示崇高的敬意和诚挚的谢意!</p>', '/upload/1556208529968.jpg', '2019-04-26 00:08');
